...
public class SobotTransferCustomActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private EditText sobot_isArtificialIntelligence_num;//如果是智能转人工，需要设置当应到问题出现几次以后显示转人工按钮
    private EditText sobot_demo_transferKeyWord;//智能转人工关键字
    ...
    private void getSobotStartSet() {
        ...
        String sobot_transferKeyWord_value = SobotSPUtil.getStringData(this, "sobot_transferKeyWord", "");
        if (!TextUtils.isEmpty(sobot_transferKeyWord_value)) {
            sobot_demo_transferKeyWord.setText(sobot_transferKeyWord_value);
        }
    }
